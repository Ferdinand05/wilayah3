    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9 mt-5 mx-auto">
                <form action="/anggota/tambahAnggota" method="post">
                    <?= csrf_field() ?>
                    <input type="hidden" name="_method" value="PUT">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="nama">Nama</label>
                        <input placeholder="Nama..." type="text" class="form-control <?= (session('validation')?->hasError('nama') ? 'is-invalid' : 'is-valid') ?>" id="nama" name="nama">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input placeholder="Alamat..." type="text" class="form-control <?= (session('validation')?->hasError('alamat') ? 'is-invalid' : 'is-valid') ?>" id="alamat" name="alamat">
                        <div class="invalid-feedback">
